...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(
    ...
    if (_SwipeCardsState._trigger == TriggerDirection.none) {
      endX = beginAlign.x > 0
    ...
    } else if (_SwipeCardsState._trigger == TriggerDirection.left) {
      endX = beginAlign.x - swipeEdge;
      endY = beginAlign.y + 0.5;
    }
    /* Trigger Swipe Up or Down */
    else if (_SwipeCardsState._trigger == TriggerDirection.up ||
        _SwipeCardsState._trigger == TriggerDirection.down) {
      var beginY = _SwipeCardsState._trigger == TriggerDirection.up ? -10 : 10;
